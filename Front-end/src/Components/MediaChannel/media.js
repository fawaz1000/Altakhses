...
export default function MediaChannel() {
  ...
  if (loading) {
    return (
      <section className="relative bg-white py-20 px-4 min-h-screen flex items-center justify-center overflow-hidden">
  ...
  return (
    <section id="media" className="relative bg-white py-24 px-4 rtl text-right overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1800px] mx-auto">
        ...
        <div className="text-center mt-12">
          <div className="inline-flex items-center gap-4 bg-white/80 backdrop-blur-xl px-8 py-4 rounded-2xl shadow-xl border border-gray-200">
